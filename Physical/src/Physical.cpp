...
void UrineTest::displaya(){
ofstream outfile;
outfile.open("report.txt", ios::out);
outfile << "Urine Colour:" << colour << endl;
outfile << "pH-value:" << pH << endl;
outfile << "RBC Count:" << RBC << endl;
outfile << "WBC Count:" << WBC << endl;
...
void VitalSigns::displayb(){
ofstream outfile;
outfile.open("report.txt", ios::out);
outfile << "Temperature:" << temp << endl;
outfile << "Heart-Rate" << HR << endl;
outfile << "Respiratory-Rate:" << RR << endl;
outfile << "Annotations:" << comment << endl;
}
...
ofstream outfile;
outfile.open("report.txt", ios::out);
outfile << "Light Examination:" << eyes << endl;
outfile << "Otoscopy:" << ears << endl;
outfile << "Occlusion:" << nose << endl;
outfile << "Annotations:" << comment << endl;
}
